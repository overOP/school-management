"use client";
import { teacherFormProps } from "@/types/formType";
...
const TeacherForm = ({ type, data }: teacherFormProps) => {
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      {/* htmlfor is used to connect the label with the input */}
      ...
      dark:bg-blue-600 dark:hover:bg-blue-700 text-white py-2 px-4 rounded-md border-0"
      >
