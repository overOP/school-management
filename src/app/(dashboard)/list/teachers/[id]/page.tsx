    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="dark:bg-[#171616] p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-400">
            <Link className="p-3 rounded-md bg-sky-200" href="/">Teacher&apos;s Classes</Link>
            ...
            <Link className="p-3 rounded-md bg-pink-200" href="/">Teacher&apos;s Exams</Link>
            <Link className="p-3 rounded-md bg-sky-200" href="/">Teacher&apos;s Assignments</Link>
        </div>
      </div>
      <Performance />
      <Announcements/>
